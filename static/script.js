...
function insert_comments() {
  ...
  comment_section.setAttribute("data-category", "Announcements")
  comment_section.setAttribute("data-category-id", "DIC_kwDOMXqdqc4CkeUH")
  comment_section.setAttribute("data-mapping", "pathname")
  comment_section.setAttribute("data-strict", "1")
  comment_section.setAttribute("data-reactions-enabled", "1")
  comment_section.setAttribute("data-emit-metadata", "0")
  comment_section.setAttribute("data-input-position", "top")
  comment_section.setAttribute("data-theme", "preferred_color_scheme")
  comment_section.setAttribute("data-lang", "en")
