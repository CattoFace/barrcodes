...
## Improving Things:
Solving the backwards bug is not hard, after a quick google search, I learned I simply need to listen to the `popstate` event that happens when a browser goes back, and set the right document content:
```javascript
